      ...
      >
        <div className="hidden md:flex flex-col justify-center flex-1 bg-white">
          ...
          <p className="font-light text-md w-[70%] mx-auto">
            Discover amazing deals and unique treasures right in your
            neighborhood! Our marketplace connects you with listings from people
            within a 65km radius, making it easy to find what you need close to
            home.
          </p>
        </div>
