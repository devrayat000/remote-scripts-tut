...
import { Player } from "https://esm.sh/@lottiefiles/react-lottie-player@^3.5.4?deps=react@^18.3.1,react-dom@^18.3.1";
import { motion } from "https://esm.sh/framer-motion@^11.2.14?deps=react@^18.3.1,react-dom@^18.3.1";
import Container from "../../components/container/Container";
import { IoMdCloseCircle } from "https://esm.sh/react-icons@^5.2.1/io?deps=react@^18.3.1,react-dom@^18.3.1";
      ...
      >
        <div className="hidden md:flex flex-col justify-center flex-1 bg-white rounded-3xl">
          ...
          <p className="font-light text-md w-[90%] lg:w-[70%] mx-auto">
            Whether you&apos;re hunting for the perfect gift or treating
            yourself to something special, this space is your go-to destination
            for local finds. Join our community of savvy shoppers and start
            exploring today—your next great find is just around the corner!
          </p>
        </div>
