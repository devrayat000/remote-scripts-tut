      ...
      <div className="flex h-[520px] border rounded-md">
        {images.length === 0 ? (
          <div className="text-lg flex flex-col items-center justify-center w-[60%] bg-[#f0f2f5] rounded-md">
            ...
            <p className="w-[80%] mx-auto">
              As you create your listing, you can preview how it would appear to
              others
            </p>
          </div>
        ) : (
        ...
        <div className="w-[40%] p-5 text-sm overflow-auto">
          ...
          <div className="mt-5">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[#720D96] cursor-pointer transition ease-in-out hover:underline duration-500">
                Seller details
              </span>
            </div>
