...
import { useRef, useState, useEffect } from "https://esm.sh/react@^18.3.1";
import { BiSolidImageAdd } from "https://esm.sh/react-icons@^5.2.1/bi?deps=react@^18.3.1,react-dom@^18.3.1";
import { IoIosCloseCircle } from "https://esm.sh/react-icons@^5.2.1/io?deps=react@^18.3.1,react-dom@^18.3.1";
...
const AddPhotos = ({ onImagesChange }) => {
  ...
  useEffect(() => {
    return () => {
      selectedFiles.forEach((fileData) => URL.revokeObjectURL(fileData.id));
    };
  }, [selectedFiles]);
