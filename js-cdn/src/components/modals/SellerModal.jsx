...
import {
  ...
  IoMdCloseCircle,
  IoMdSearch,
} from "https://esm.sh/react-icons@^5.2.1/io?deps=react@^18.3.1,react-dom@^18.3.1";
    ...
    >
              ...
              <div className="px-5 py-5">
                <div>
                  ...
                  <p className="text-[#77797c] md:text-lg">
                    <span className="text-[#141414] font-semibold">20+</span>{" "}
                    active listings ·{" "}
                    <span className="text-[#141414] font-semibold">118</span>{" "}
                    followers
                  </p>
                  <p className="text-[#141414] md:text-lg text-center mt-2">
                    Bringing Innovation Home: Where Quality Meets Convenience!
                  </p>
                </div>
                <hr />
                <div className="pt-3">
                  ...
                  <p className="text-sm">
                    Welcome to Emmymall Electronics. Dealer in home electronics
                    and appliances like fridge, TV, home theater, blenders,
                    washing machine, fans, air conditioner, solar generator, .
                    You are guaranteed to get the best product at the best
                    affordable rate. We offer free delivery for Lagos residents
                    only. We are here for you 24/7 to give you the best
                  </p>
                </div>
                <hr />
                <div className="pt-3">
      ...
      <div className="md:hidden bg-white fixed inset-0 z-30 transition-all duration-500 overflow-y-scroll ">
        ...
        <div className="">
          ...
          <div className="px-5 py-5">
            <div>
              <h1 className="text-2xl font-bold">Sunday Prince Chukwuemeka</h1>
              <p className="text-[#77797c] my-2">Joined in 2012</p>
              <p className="text-[#77797c]">
                <span className="text-[#141414] font-semibold">20+</span> active
                listings ·{" "}
                <span className="text-[#141414] font-semibold">118</span>{" "}
                followers
              </p>
            ...
            <div className="pt-3 mb-5">
              <h2 className="font-semibold text-xl">About</h2>
              <p className="text-sm">
                Welcome to Emmymall Electronics. Dealer in home electronics and
                appliances like fridge, TV, home theater, blenders, washing
                machine, fans, air conditioner, solar generator, . You are
                guaranteed to get the best product at the best affordable rate.
                We offer free delivery for Lagos residents only. We are here for
                you 24/7 to give you the best
              </p>
            </div>
            <hr />
            <div className="pt-3">
