...
import { IoIosShareAlt } from "https://esm.sh/react-icons@^5.2.1/io?deps=react@^18.3.1,react-dom@^18.3.1";
import image from "../../assets/image1.png";
import { TiMessages } from "https://esm.sh/react-icons@^5.2.1/ti?deps=react@^18.3.1,react-dom@^18.3.1";
      ...
      <div className="md:pl-10 lg:pl-0 2xl:pl-10">
        ...
        <div className="mt-3">
          ...
          {showFullDescription && (
            <p className="lg:text-lg mb-5">
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. This
              hoodie is very comfortable and soft on the skin{" "}
              <span
                className="underline text-[#b3b4b6] cursor-pointer hover:text-[#141414]"
        ...
        <div className="mt-3">
          <div className="flex justify-between items-center">
            <span className="font-semibold text-xl">Seller information</span>
            <span
